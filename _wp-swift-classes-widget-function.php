<?php
/*
Plugin Name:       WP Swift: Classes Widget
Description:       A widget that shows all school class links
Version:           1.0.0
Author:            Gary Swift
License:           GPL-2.0+
Text Domain:       wp-swift-classes-widget
*/
 
class WP_Swift_Classes_Widget extends WP_Widget {
 
    public function __construct() {
     
        parent::__construct(
            'wp_swift_classes_widget',
            __( 'WP Swift: Classes Widget', 'wp-swift-classes-widget' ),
            array(
                'classname'   => 'wp_swift_classes_widget',
                'description' => __( 'A widget that shows all school class links.', 'wp-swift-classes-widget' )
                )
        );
       
        load_plugin_textdomain( 'wp-swift-classes-widget', false, basename( dirname( __FILE__ ) ) . '/languages' );
    ...
    public function widget( $args, $instance ) {    
        ...
        include( plugin_dir_path( __FILE__ ) . '_wp-swift-classes-widget.php');
    }
...
add_action( 'widgets_init', function(){
     register_widget( 'WP_Swift_Classes_Widget' );
});